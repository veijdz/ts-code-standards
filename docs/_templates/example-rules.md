...
> Fictional, filled example of a `rules.md` section. Demonstrates the anatomy of `docs/_templates/rules.md`. Real Cat 7 content lands in VEI-422.
...
- This file is an example, not authoritative. The real Cat 7 file is generated by VEI-422.
- The first line above references the template that drives the structure (`<!-- Based on docs/_templates/rules.md -->`). Future stack rules should keep that reference.
