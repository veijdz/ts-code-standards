...
> Forward references to `stacks/base/docs/rules.md` below point to a file that is built progressively, one file per category; today the path is a placeholder.
